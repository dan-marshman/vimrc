...
" Plugins with Vundle 
    "Finds the path to Vundle
        ...
        elseif hostname == "DELL"
            set rtp+=C:/Users/Dan/.vim/bundle/Vundle.vim
        elseif hostname == "TPad"
            set rtp+=/home/dan/.vim/bundle/Vundle.vim
        elseif hostname == "ACER-WINDOWS"
            set rtp+=C:/Users/danie/vimfiles/bundle/Vundle.vim
...
""Pymode uses python 2 by default. Make it use python 3
    ...
    "Seem to need to set these on MR
        ...
        elseif hostname == "ACER-WINDOWS"
            set pythonthreehome=C:\Users\danie\AppData\Local\Programs\Python\Python38-32
            set pythonthreedll=C:\Users\danie\AppData\Local\Programs\Python\Python38-32\python38.dll
            let $PYTHONHOME = 'C:\Users\danie\AppData\Local\Programs\Python\Python38-32'
        endif 
...
"VIMRC
    " leader-rc opens the syncthing vimrc
        ...
        elseif hostname == "DELL"
            map <leader>rc :tabnew ~/Documents/syncthing/code/vimrc_file/_vimrc<CR>
        elseif hostname == "TPad"
            map <leader>rc :tabnew /home/dan/syncthing/code/vimrc_file/_vimrc<CR>
        elseif hostname == "ACER-WINDOWS"
            map <leader>rc :tabnew ~/syncthing/code/vimrc_file/_vimrc<CR>
        elseif hostname() == "acer-artix"
            map <leader>rc :tabnew ~/syncthing/code/vimrc_file/_vimrc<CR>
            map <leader>xc :tabnew ~/syncthing/code/vimrc_file/_vimrc<CR>
        endif 

    " leader-gg saves, sources and re-opens
       cu BufRead,BufNewFile _vimrc nnoremap <buffer> <leader>g :w<CR>:so %<CR>:e %<CR>
" R
    "Run with F9
